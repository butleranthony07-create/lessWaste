...
## Настройки
### Backup
Описание: если включено резервирование и есть совпадающие типы и цвета филамента, каналы объединяются. Резервные позиции задаются в начале печати и расходуются по мере необходимости.
Если во время печати срабатывает backup, активируется канал с наименьшим номером (сканирование 1 → 4).
Когда резерв закончился и произошла пауза, использованные каналы можно снова заполнить.
